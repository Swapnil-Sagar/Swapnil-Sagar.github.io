				...
				<div className='skills-me'>
					<span>
						...
						<Animator animation={batch(Sticky(), MoveIn(0, 1000))}>
							<div style={{ top: '37vh', left: '0' }} className='skills-wrapper' id='responsive'>
								<p>
									Responsive <br /> Design
								</p>
								<div
									style={{ right: '10rem', bottom: '15vh', fontSize: '20px' }}
									className='subskill'
								>
						...
						<Animator animation={batch(Sticky(), MoveIn(0, -1000))}>
							<div style={{ bottom: '35vh', left: '0' }} className='skills-wrapper' id='web3'>
								<p>Web3</p>
								<div
									style={{ right: '12vw', bottom: '5vh', fontSize: '35px' }}
									className='subskill'
								>
						...
						<Animator animation={batch(Sticky(), MoveIn(-1000, -1000))}>
							<div style={{ bottom: '200px', left: '-32vw' }} className='skills-wrapper' id='react'>
								<p>React</p>
								<div
									style={{ left: '6rem', bottom: '2rem', fontSize: '35px' }}
						...
						<Animator animation={batch(Sticky(), MoveIn(-1000, 0))}>
							...
							>
								...
								<div style={{ right: '0', bottom: '7rem', fontSize: '20px' }} className='subskill'>
									<p style={{ fontSize: '54px' }}>DSA</p>
								</div>
								<div style={{ right: '5rem', top: '5rem', fontSize: '20px' }} className='subskill'>
									<p style={{ fontSize: '64px' }}>OOPS</p>
								</div>
								<div style={{ left: '9rem', top: '9rem', fontSize: '20px' }} className='subskill'>
						...
						<Animator animation={batch(Sticky(), MoveIn(-1000, 1000))}>
							<div style={{ top: '200px', left: '-32vw' }} className='skills-wrapper' id='native'>
								<p>React Native</p>
